...
!function (e, t) {
    ...
    S.ajaxSetup({
        ...
        setOffset: function (e, t, n) {
            ...
            "statics" === l && (e.style.position = "relative"), s = c.offset(), o = S.css(e, "top"), u = S.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (a = (r = c.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), m(t) && (t = t.call(e, n, S.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : ("number" == typeof f.top && (f.top += "px"), "number" == typeof f.left && (f.left += "px"), c.css(f))
        }
    }, S.fn.extend({
        offset: function (t) {
            ...
            if (this[0]) {
                ...
                if ("fixed" === S.css(r, "position")) t = r.getBoundingClientRect(); else {
                    ...
                    while (e && (e === n.body || e === n.documentElement) && "statics" === S.css(e, "position")) e = e.parentNode;
            ...
            return this.map(function () {
                ...
                while (e && "statics" === S.css(e, "position")) e = e.offsetParent;
                return e || re
            })
        }
